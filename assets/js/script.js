...
var weather = function(latitude, longitude) {
    var apiUrl2 = 'https://api.openweathermap.org/data/2.5/onecall?lat='+latitude + '&lon=' +longitude + '&units=imperial&exclude=minutely,hourly,alerts&appid=4253bc5e2147b614fe1510a5ddf5c0c5';
    ...
    var dataResponse = response.current;
        ...
        const {icon} = response.current.weather[0];
                ...
                let weatherImage = dataResponse.current.weather[0].icon;
                currentPicture.setAttribute("src", "https://openweathermap.org/img/wn/" + weatherImage + "@2x.png");
                
    

                const forecastTempEl = document.createElement("p");
                currentTemperature.innerHTML = "Temperature: " + k2f(dataResponse.temp) + "&#176F";
